...
file.copy(here::here("Facts/Single_Fact_Files/All_Facts_Small.pdf"), 
          here::here("Facts/Single_Fact_Files/All_Facts.pdf"), overwrite = T)
file.remove(here::here("Facts/Single_Fact_Files/All_Facts_Small.pdf"))
